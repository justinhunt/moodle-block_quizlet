...
$string['exporttofileheader'] = 'Export Quizlet Sets';
$string['exporttoquestionsheader'] = 'Export To Moodle Questions (XML Format)';
$string['exporttoddropheader'] = 'Export To Moodle Drag and Drop';
...
$string['dd_exportlink'] = 'Export Activities from Quizlet<br />';
$string['qq_exportlink'] = 'Export Questions from Quizlet<br />';
